package com.ghale.service.guest;
...
public class GuestController {
    ...
    @ApiOperation(value="Get a Guest", notes="Find guest by id", nickname="getAGuest")
    public Guest findOne(@PathVariable(name="id")String id){
        return this.guestRepository.findByGuestId(Long.valueOf(id));
    }
}
